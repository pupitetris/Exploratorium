...
# xlsx2csv: Convert supported spreadsheet formats to CSV
#	    (m)'23 [2023-12-04] Copyright H.M.Brand 2008-2024

# Copied from https://github.com/Tux/Spreadsheet-Read/blob/master/scripts/xlsx2csv
...
use Spreadsheet::Read qw( ReadData row ); # libspreadsheet-read-perl libspreadsheet-readsxc-perl
...
if ($opt_A || $opt_Z) {
	...
	$opt_v and warn "Saving sheet to $fn ...\n";
...
$opt_v and warn "Converting $xls to $csv ...\n";
