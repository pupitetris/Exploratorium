...
CREATE VIEW v_attr_class_diagram AS
        SELECT attribute_desc.label AS attribute_label,
          ...
          FROM attribute,
               ...
               diagram,
               attribute_diagram
         WHERE attribute.attribute_id = attr_diagram_class.attribute_id AND 
               attr_diagram_class.attribute_id = attribute_desc.attribute_id AND 
               attr_diagram_class.attr_class_id = attr_class.attr_class_id AND 
               diagram.diagram_id = attribute_diagram.diagram_id AND 
               attribute.attribute_id = attribute_diagram.attribute_id
...
CREATE VIEW v_attribute_classes AS
        SELECT ac.code AS Code,
          ...
          FROM attr_class AS ac
               LEFT JOIN attr_class_desc AS en ON ac.attr_class_id = en.attr_class_id AND 
                                                  en.lang_code = 'en'
               LEFT JOIN attr_class_desc AS es ON ac.attr_class_id = es.attr_class_id AND 
                                                  es.lang_code = 'es'
         ORDER BY ac.ord
...
CREATE VIEW v_attribute_diagram AS
        SELECT attribute_desc.attribute_id AS attr_id,
               attribute_desc.label AS attribute_label,
               diagram.code AS diagram_code,
               diagram.diagram_id AS dia_id,
               diagram_class.code AS diagram_class
          FROM attribute_diagram,
               attribute_desc,
               diagram,
               diagram_class
         WHERE attribute_diagram.attribute_id = attribute_desc.attribute_id AND 
               diagram.diagram_id = attribute_diagram.diagram_id AND 
               attribute_desc.diagram_class_id = diagram_class.diagram_class_id
...
CREATE VIEW v_context_assignments AS
        SELECT contexts.Lang,
          ...
          FROM v_contexts AS contexts
               LEFT OUTER JOIN object_attribute ON contexts.object_id = object_attribute.object_id AND 
                                                   contexts.attribute_id = object_attribute.attribute_id AND 
                                                   contexts.diagram_id = object_attribute.object_diagram_id
         ORDER BY contexts.Diagram ASC,
                  contexts.Object ASC
...
CREATE VIEW v_contexts AS
        SELECT lang.lang_label AS Lang,
          ...
          FROM lang,
               ...
               attribute_diagram,
               object_diagram
         WHERE object_desc.lang_code = lang.lang_code AND 
               attribute_desc.lang_code = lang.lang_code AND 
               attribute.attribute_id = attr_diagram_class.attribute_id AND 
               attr_diagram_class.attribute_id = attribute_desc.attribute_id AND 
               attr_diagram_class.diagram_class_id = attribute_desc.diagram_class_id AND 
               attr_diagram_class.attr_class_id = attr_class.attr_class_id AND 
               attribute_diagram.attribute_id = attribute.attribute_id AND 
               diagram_class.diagram_class_id = diagram.diagram_class_id AND 
               diagram_class.diagram_class_id = attribute_desc.diagram_class_id AND 
               diagram.diagram_id = attribute_diagram.diagram_id AND 
               object_diagram.object_id = object_desc.object_id AND 
               diagram.diagram_id = object_diagram.diagram_id
         ORDER BY "Lang" ASC,
                  "Diagram" ASC,
                  "Object" ASC,
                  "Attribute" ASC
...
CREATE VIEW v_diagram_class AS
        SELECT diagram_id,
               ...
               dc.code AS class
          FROM diagram AS d
               JOIN diagram_class AS dc USING
               (
                       diagram_class_id
               )
